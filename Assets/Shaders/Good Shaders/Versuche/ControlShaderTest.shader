							  ...
							  */
							  ...
							  /*if (_RotationFactor == 1.0) {
								...
								if (_RotationFactor == 1.0) {
								  ...
								  //if (_Front == 1.0 && (dd != 0.0) && (dd <= radius) && centerVector.y >= 0.0) {
								  if (_Front == 1.0 && (dd != 0.0) && (dd <= radius) && frontDot <= 0.0) {
								  ...
								  //if ((dd != 0.0) && (dd <= radius) && centerVector.x >= 0.0) {
									  if (_Right == 1.0 && (dd != 0.0) && (dd <= radius) && rightDot >= 0.0) {
									  ...
									  //if (_Left == 1.0 && (dd != 0.0) && (dd <= radius) && centerVector.x <= 0.0) {
										  if (_Left == 1.0 && (dd != 0.0) && (dd <= radius) && leftDot >= 0.0) {
									  ...
									  if (_RotationFactor == 0.0) {
										  //if (_Back == 1.0 && (dd != 0.0) && (dd <= radius) && centerVector.x >= 0.0) {
											  if (_Back == 1.0 && (dd != 0.0) && (dd <= radius) && backDot <= 0.0) {
											  ...
											  //if (_Front == 1.0 && (dd != 0.0) && (dd <= radius) && centerVector.x <= 0.0) {
												  if (_Front == 1.0 && (dd != 0.0) && (dd <= radius) && frontDot <= 0.0) {
												  ...
												  //if (_Right == 1.0 && (dd != 0.0) && (dd <= radius) && centerVector.y >= 0.0) {
													  if (_Right == 1.0 && (dd != 0.0) && (dd <= radius) && rightDot <= 0.0) {
													  ...
													  //if (_Left == 1.0 && (dd != 0.0) && (dd <= radius) && centerVector.y <= 0.0) {
														   if (_Left == 1.0 && (dd != 0.0) && (dd <= radius) && leftDot <= 0.0) {
